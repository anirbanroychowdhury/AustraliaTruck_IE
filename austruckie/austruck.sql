...
(11, 'This sign has been introduced on some three-lane and four -lane freeways in Victoria. It prohibits all heavy vehicles over 4.5 tonnes, except buses and caravans, from travelling in the right lane wherever it is displayed. The restriction applies 24 hours a day.', 1, NULL, NULL, NULL, NULL),
(12, 'Load limit signs may apply to bridges or sections of road. You must not pass this sign if axle group mass of your vehicle is more than that allowed by the sign. Fines are heavy and you might have to pay for damage caused to roads that cannot take the weight of your vehicle.', 2, NULL, NULL, NULL, NULL),
(13, 'Load limit signs may apply to bridges or sections of road. You must not pass this sign. Fines are heavy and you might have to pay for damage caused to roads that cannot take the weight of your vehicle.', 3, NULL, NULL, NULL, NULL),
(14, 'if the driver of a truck drives past a trucks must enter sign, the driver must enter the area indicated by information on or with the sign.', 2, NULL, NULL, NULL, NULL),
(15, 'No goods-carrying vehicle over 4.5 tonnes GVM can pass this sign without a permit from VicRoads or from the local council, unless the following exemptions apply: \r\n» the driver travels beyond the sign in any other lane, or \r\n» the driver of the truck is loading or unloading at a location beyond the no truck sign and no suitable alternative route to the location exists \r\n» the driver is escorted by a police officer or an authorised officer of the corporation.', 2, NULL, NULL, NULL, NULL),
(16, 'This sign will tell you the clearance under the bridge and may indicate a detour to avoid the obstruction. Check that your vehicle will fit under the bridge. You must know your maximum vehicle height.', 2, NULL, NULL, NULL, NULL),
...
(18, 'Clearance signs will tell you the clearance under an obstruction. These signs are only used where the clearance is at least 4 metres. If your vehicle is the height on the sign or higher, you must not drive under it.', 2, NULL, NULL, NULL, NULL),
